...
public class ApiController implements EWrapper
{
    ...
    private final HashMap<Integer, IHistoricalDataHandler> m_historicalDataMap = new HashMap<Integer,
    ...
    private final HashMap<Integer, IAccountSummaryHandler> m_acctSummaryHandlers = new HashMap<Integer,
			IAccountSummaryHandler>();
    private final HashMap<Integer, IMarketValueSummaryHandler> m_mktValSummaryHandlers = new HashMap<Integer,
			IMarketValueSummaryHandler>();
    ...
    private final HashMap<Integer, IPositionMultiHandler> m_positionMultiMap = new HashMap<Integer,
			IPositionMultiHandler>();
    private final HashMap<Integer, IAccountUpdateMultiHandler> m_accountUpdateMultiMap = new HashMap<Integer,
			IAccountUpdateMultiHandler>();
    private final HashMap<Integer, ISecDefOptParamsReqHandler> m_secDefOptParamsReqMap = new HashMap<Integer,
			ISecDefOptParamsReqHandler>();
    ...
    {
        void tickOptionComputation(TickType tickType,
                                   double impliedVol,
                                   double delta,
                                   double optPrice,
                                   double pvDividend,
    ...
    {
        void updateMktDepth(int position,
                            String marketMaker,
                            DeepType operation,
                            DeepSide side,
                            double price,
    ...
    @Override
    public void updateMktDepthL2(int reqId,
                                 int position,
                                 String marketMaker,
                                 int operation,
                                 int side,
    ...
    @Override
    public void tickOptionComputation(int reqId,
                                      int tickType,
                                      double impliedVol,
                                      double delta,
                                      double optPrice,
                                      ...
                                      double undPrice)
    {
        ...
        if (handler != null)
        {
            handler.tickOptionComputation(TickType.get(tickType),
                                          impliedVol,
                                          delta,
                                          optPrice,
                                          pvDividend,
        ...
        {
            System.out.println(String.format("not handled %s %s %s %s %s %s %s %s %s",
                                             tickType,
                                             impliedVol,
                                             delta,
                                             optPrice,
                            ...
                            String whyHeld)
    {
        ...
        if (handler != null)
        {
            handler.orderStatus(OrderStatus.valueOf(status),
                                filled,
                                remaining,
                                avgFillPrice,
                                permId,
        ...
        {
            liveOrderHandler.orderStatus(orderId,
    ...
    public void reqAccountUpdatesMulti(String account,
                                       String modelCode,
    ...
    public void reqSecDefOptParams(String underlyingSymbol,
                                   String futFopExchange, /*String currency,*/
                                   ...
                                   ISecDefOptParamsReqHandler handler)
    {
        ...
        m_client.reqSecDefOptParams(reqId,
                                    underlyingSymbol,
                                    futFopExchange, /*currency,*/
                                    underlyingSecType,
                                    underlyingConId);
        sendEOM();
    }
                                                    ...
                                                    Set<Double> strikes)
    {
        ...
        if (handler != null)
        {
            handler.securityDefinitionOptionalParameter(exchange,
                                                        underlyingConId,
                                                        tradingClass,
                                                        multiplier,
                                                        expirations,
