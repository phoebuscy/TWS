...
public class AdjustedPanel extends OnOKPanel {
	...
	final TCombo<TicketDlg.AmntUnit> m_adjustedTrailingAmountUnit = new TCombo<TicketDlg.AmntUnit>(TicketDlg.AmntUnit
                                                                                                           .values());
	...
	public AdjustedPanel(JDialog parentDlg, Order order) {
		...
		m_adjustedTrailingAmountUnit.setSelectedItem(TicketDlg.AmntUnit.fromInt(m_order.adjustableTrailingUnit()));
